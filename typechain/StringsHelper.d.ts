...
interface StringsHelperInterface extends ethers.utils.Interface {
  functions: {
...
export class StringsHelper extends Contract {
  ...
  interface: StringsHelperInterface;
  ...
  "asString(address)"(addr: string, overrides?: CallOverrides): Promise<string>;
